...
Django, React\\ \\
{\bf Tools}: 
Git, Keras, PyTorch, Scikit-learn, Numpy, Pandas, Matplotlib, tkinter, psycopg2, Docker,  Gephi, NetworkX,  Latex, Adobe Photoshop/ Illustrator, Cisco, Mikrotik, Kerio Firewall \\ \\
{\bf Database }: PostgreSQL, MySQL, MongoDB, SQL Server \\ \\ 
